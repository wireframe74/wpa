<div class="footer-wrap container">
	...
	<script type="text/javascript">
				...
				<h1>ABOUT</h1>
				<p>The Academy Blog is where you will find articles, tips and advice from our tutors and team of wonderful wedding experts all happy to help you in your career as a wedding planner, stylist or designer. We have a wealth of information for both the aspiring and established wedding professional including some free-to-air videos and lots of interviews with some top industry professionals.
No subject is off limits and we cover many different topics including marketing, business, social media, trends, styling, design, finance, pricing, planning and much more.</p>
				
				<p>
				<a class="btn btn-lg btn-primary" href="<?php bloginfo('url'); ?>/about" role="button">View</a>
				</p>
				</section><!-- banner-advert -->
