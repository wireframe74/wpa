...
if (function_exists('add_theme_support'))
{
    ...
    add_image_size('category-thumb', 340, 312, true); // Custom Thumbnail Size call using the_post_thumbnail('custom-size');
...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        ...
        wp_register_script('jquery', 'http://ajax.googleapis.com/ajax/libs/jquery/1.10.0/jquery.min.js', array(), '1.9.0', true); // Google CDN jQuery
        ...
        wp_register_script('boostrap', get_template_directory_uri() . '/assets/js/bootstrap.min.js', array(), '1.0.0'); // Google CDN jQuery
        wp_enqueue_script('boostrap'); 

        wp_register_script('liquidimg', get_template_directory_uri() . '/assets/js/imgLiquid-min.js', array(), '1.0.0'); // Google CDN jQuery
        wp_enqueue_script('liquidimg'); 

        wp_register_script('video', get_template_directory_uri() . '/assets/js/video.js', array(), '1.9.0'); // Google CDN jQuery
        wp_enqueue_script('video'); 

        wp_register_script('custom', get_template_directory_uri() . '/assets/js/custom.js', array(), '1.9.0'); // Google CDN jQuery
...
function catch_that_image ($post_id=0, $width=60, $height=60, $img_script='') { // you can set any params here
