...
<form class="search" method="get" action="http://www.weddingplanningacademy.co.uk/?blog=true" role="search">
	...
	<button class="search-submit" type="submit" role="button">Search</button>
      ...
      <?php if(is_page('blog') || is_search()  ) :?> 

	  <?php include_once('slider.php'); ?>

      <?php else : ?>

       <?php include_once('post-banner.php'); ?>
